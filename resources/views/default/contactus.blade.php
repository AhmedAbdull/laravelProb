          ...
          <form method="get" action="/contactus">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" name="client_subject"  value="{{ old('client_subject') }}" >
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="client_comment"  value="{{ old('client_comment') }}" >
