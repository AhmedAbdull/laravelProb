...
<head>
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="post" action="<?php echo e(url('shop/admin')); ?>" ><?php echo e(csrf_field()); ?>

            	
				 <div class="control-group normal_text"> <h3><img src="<?php echo e(asset('img/backend_images/logo.png')); ?>" alt="Logo" /></h3></div>
        
           
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="email" name="email" id="email" placeholder="Username" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
