...
<?php $__env->startSection('shopname'); ?>
<?php $__env->stopSection(); ?>
...
<div class="col-xl-6">
	...
	<p style="font-size: 30px;"><?php echo e($product->description); ?></p>
	<table >
		<tr> 
			<td> <p style="font-size: 30px;">Price:</p> </td>
			<td> <p style="font-size: 30px;"><?php echo e($product->price); ?> </p> </td>
		</tr>	
	</table>
	</div>			
	</div>
...
<?php echo $__env->make('mainShop.index', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>